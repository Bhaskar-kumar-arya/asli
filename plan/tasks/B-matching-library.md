...
**Status:** DONE (human reviewed `src/classify.ts` against docs/MATCHING.md's tier table in chat on 2026-09-18 and approved; merged to `main`)
...
**Remaining:**
- Nothing - human review done, merged to `main`. `packages/matching` is ready for C, F, G2, and A1 to import now.
**Gotchas / decisions:**
